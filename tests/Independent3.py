...
class MTGP:
    def __init__(self, num_tasks, lr=0.1, training_iterations=50):
...
# combined_train_y = torch.randn(1000, num_tasks)

mtgp = MTGP(num_tasks)
mtgp.train(X)
W, derivative = mtgp.get_graph(X)
print("RMS Jacobian (10x10 matrix):", W.shape)
print("Jacobian (1000x10x10 matrix):", derivative.shape)
print(f"Jacobian: {W}")
# import math
# import torch
# import gpytorch
...
# derivative = torch.zeros(1000, 10, 10)
